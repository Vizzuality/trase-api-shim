...
class GetColumns:
    ...
    def flow_nodes_metadata(self, context_slug):
        sql = "SELECT column_in_supply_chains_table, short_name, display_order, display_by_default FROM `trase-396112.website.flows_nodes_metadata` WHERE context_slug = @context_slug ORDER BY display_order"
